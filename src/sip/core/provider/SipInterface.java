 ...
 * parameters, have to be specified: <b> - <i>sipProvider<i/> is the
 ...
 * to receive for. Together with the <i>sipProvider<i/>, it represents the
...
public class SipInterface implements SipProviderListener {
	...
	public ConnectionIdentifier sendMessage(Message msg, String proto,
                                            String destAddr, int destPort, int ttl) {
		return sip_provider.sendMessage(msg, proto, destAddr, destPort, ttl);
	}
