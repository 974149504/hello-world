...
import com.allcam.gbgw.protocol.sip.core.dialog.ExtendedInviteDialog;
import com.allcam.gbgw.protocol.sip.core.dialog.ExtendedInviteDialogListener;
...
public class ExtendedCall extends Call implements ExtendedInviteDialogListener
{
    ...
    /*
     * public ExtendedCall(SipProvider sipProvider, String fromUrl, String
     * contactUrl, String sdp, ExtendedCallListener call_listener) {
     * super(sipProvider,fromUrl,contactUrl,sdp,call_listener);
    ...
    {
        Log.compatLog("ExtendedCall: " + str, level);
    }
}
