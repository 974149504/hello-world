...
public interface CallListener
{
     ...
     * call)
     */
    void onCallIncoming(Call call, NameAddress callee, NameAddress caller, String sdp, Message invite);

    /**
     * Callback function called when arriving a new Re-INVITE method
     * (re-inviting/call modify)
     */
    void onCallModifying(Call call, String sdp, Message invite);
     ...
     */
    void onCallAccepted(Call call, String sdp, Message resp);

    /**
     * Callback function called when arriving a 4xx (call failure)
     */
    void onCallRefused(Call call, String reason, Message resp);

    /**
     * Callback function called when arriving a 3xx (call redirection)
     */
    void onCallRedirection(Call call, String reason, Vector<String> contact_list, Message resp);

    /**
     * Callback function called when arriving an ACK method (call confirmed)
     */
    void onCallConfirmed(Call call, String sdp, Message ack);
     ...
     */
    void onCallReInviteAccepted(Call call, String sdp, Message resp);

    /**
     * Callback function called when arriving a 4xx (re-invite/modify failure)
     */
    void onCallReInviteRefused(Call call, String reason, Message resp);
